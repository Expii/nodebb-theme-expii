...
<div class="row">
	...
	<div class="<!-- IF allowLocalLogin -->col-md-6<!-- ELSE -->col-md-12<!-- ENDIF allowLocalLogin -->">
		<div class="well well-lg">
			<h4>Login via expii.com</h4>
			<ul class="alt-logins">
				<!-- BEGIN authentication -->
				<li class="{authentication.name}"><a rel="nofollow" href="{relative_path}{authentication.url}"><i class="fa {authentication.icon} fa-3x"></i> <span class="expii-login-link">Click here to proceed.</span></a></li>
				<!-- END authentication -->
			</ul>
		</div>
	</div>
