			<div class="navbar-header">
				...
				<div>
                                    <!-- From Po: make left side of logo send to our site, and right side of logo send to front page of forum -->
                                    <!-- Wrap in a div which is invisible
                                    until locked at top -->
                                    <div class="expii-masthead-logo">
